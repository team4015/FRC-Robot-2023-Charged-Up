...
public class AutoMoveArm extends CommandBase
{
  ...
  public AutoMoveArm(Robot robot, double armSpeed, double time)
  {
    this.robot = robot;
  ...
  public void initialize()
  {
   ...
   endCommand = false; 
   SmartDashboard.putString("Robot Mode:", "Move Arm");
  }
  ...
  {
   robot.arm.stopRack(); 
   if (SmartDashboard.getString("Robot Mode:", "").equals("Move Arm")) {
